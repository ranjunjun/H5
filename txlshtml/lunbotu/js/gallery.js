...
jQuery.fn.gallery = function(config) {
    ...
    var no_click;
    var positions = {
        current: {zIndex: 100, top: "1%",  left: "10%" },
        left: {zIndex: 50, top: "20%", left: "-80%" },
        right: {zIndex: 25,  top: "20%", left: "88%" },
		none: {zIndex: 0,  top: "20%", left: "12%" }
    };
    var currentD = {width:"88%",height:"100%" };
    var backD = { width:"70%", height:"60%" };
...
function is_start(){
    ...
    var bindEvent = function() {
		...
		clearEvents();
            ...
            if(config.end) {
                setTimeout(config.end, config.duration ||500);
            }
		is_start();
        });
